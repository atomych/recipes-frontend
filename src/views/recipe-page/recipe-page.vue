<template>
  <div class="recipe-page">
    <div v-if="RECIPE_MANAGER.state.loading" class="recipe-page-loader">
      <Loader />
    </div>
    <div v-else class="recipe-page-content">
      <header class="recipe-page-header">
        ...
        />
        <div
          v-if="!RECIPE_MANAGER.state.isNew && RECIPE_MANAGER.state.recipe"
      ...
      <div v-else class="recipe-page-empty">
        <Empty
            title="Рецепт не был найден"
            subtitle="Возможно, рецепт не был найден или произошла ошибка при загрузке"
        />
      </div>
    </div>
  </div>
